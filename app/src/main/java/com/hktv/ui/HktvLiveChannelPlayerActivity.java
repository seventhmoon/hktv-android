...
//    private Response.Listener<JSONObject> getPlaylistListener =  new Response.Listener<JSONObject>() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mWebServiceManager = new WebServiceManager(this.getApplicationContext(), ((MainApplication) getApplication()).getRequestQueue());
...
//            }
    ...
    private class MyErrorListener implements Response.ErrorListener {
        ...
        public void onErrorResponse(VolleyError error) {
            ...
            showErrorDialog(getApplicationContext(), getString(R.string.text_network_error));
        }
    }
